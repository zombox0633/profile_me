...
function Profile() {
  return (
    <section className='snap-always snap-center h-screen pr-8 py-8 lg:p-8'>
      <div className="hidden sm:block">
        <h3>Profile</h3>
      </div>
      <div className='flex items-center h-full'>
        <div className='md:grid__container_col'>
          <div className="md:col-start-1 md:col-end-3 flex justify-center mb-10 sm:my-8">
          ...
          <div className='md:col-start-4 md:col-end-7 flex items-center'>
            <div>
