function Educational() {
  return (
    <section className='snap-always snap-center flex flex-wrap gap-2  h-screen p-8'>
      <div className="mb-8">
        <h3 className="hidden lg:block">Education</h3>
      </div>
      <div className="flex items-start sm:items-center h-[75vh]">
        <div className='lg:grid__container_col h-[70vh]'>
          <div className='lg:col-start-1 lg:col-end-3'>
            <div className=' mr-4 xl:mr-8 mb-4 lg:mb-0'>
              <div className=' flex items-center sm:h-20 2xl:h-8 mb-2 sm:mb-0 lg:mb-4'>
                <span className='material-symbols-outlined hidden sm:block mr-4'>polyline</span>
                <h2 className='text-lg sm:text-xl xl:text-2xl'> API Development</h2>
              </div>
              <div>
                <p className='text-[0.8rem] sm:text-[0.9rem] 2xl:text-base text-justify xl:mr-6 2xl:mr-8'>
          ...
          <div className='lg:col-start-3 lg:col-end-5 2xl:flex 2xl:flex-col 2xl:justify-center'>
            <div className='mr-4 xl:mr-8 mb-4 lg:mb-0'>
              <div className=' flex items-center sm:h-20 2xl:h-8 mb-2 sm:mb-0 lg:mb-4'>
                <span className='material-symbols-outlined hidden sm:block mr-4'>grid_view</span>
          ...
          <div className='lg:col-start-5 lg:col-end-7 2xl:flex 2xl:flex-col 2xl:justify-end'>
            <div className=' mr-4 xl:mr-12'>
              <div className=' flex items-center sm:h-20 2xl:h-8 mb-2 sm:mb-0 lg:mb-4'>
                <span className='material-symbols-outlined hidden sm:block mr-2'>architecture</span>
